			...
			<div class="fh5co-main-nav">
				<div class="container-fluid">
					<div class="fh5co-menu-1">
						...
						<a href="#" data-nav-section="about">Sobre nosotros</a>
					</div>
					<div class="fh5co-logo">
						<a href="index.html">Nativo</a>
					</div>
					<div class="fh5co-menu-2">
						<a href="#" data-nav-section="menu">Catálogo</a>
						<a href="#" data-nav-section="reservation">Contacto</a>
					</div>
				</div>
					...
					<div class="col-md-6 to-animate-2">
						...
						<ul class="fh5co-contact-info">
							<li class="fh5co-contact-address ">
								<i class="icon-home"></i>
								Licey al medio, entrada los Ulerio, #4 <br>Santiago, República Dominicana
							</li>
							<li><i class="icon-phone"></i> (829) 380-4615</li>
							<li><i class="icon-envelope"></i>alexsilverio@gmail.com</li>
		...
		<div class="container">
			<div class="row row-padded">
				<div class="col-md-12 text-center">
					<p class="to-animate">&copy; Nativo. <br> 
					</p>
